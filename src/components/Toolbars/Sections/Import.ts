...
export default (components: OBC.Components) => {
  ...
  loadBtn.tooltipText = "Carga un archivo IFC en la escena. El IFC automaticamente se convierte en fragmentos."
  ...
  return BUI.Component.create<BUI.PanelSection>(() => {
    return BUI.html`
      <bim-toolbar-section label="Importar" icon="solar:import-bold">
        ${loadBtn}
        <!-- <bim-button @click=${loadFragments} label="Fragmentos" icon="fluent:puzzle-cube-piece-20-filled" tooltip-title="Cargar fragmentos"
          tooltip-text="Carga un IFC preconvertido desde un archivo de Fragmentos. Utilice esta opción si desea evitar la conversión de IFC a Fragmentos."></bim-button> -->
        ...
        <bim-button @click=${abrirModal} label="IFC Sharepoint" icon="mdi:microsoft-sharepoint" tooltip-title="Cargar IFC desde Sharepoint"
